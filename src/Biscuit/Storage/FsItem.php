...
class FsItem {
    ...
    public function setPath( $path='' )
    {
        ...
        $this->_path      = $path;
        $this->_parent    = Utils::getValue( @$output['dirname'], '' );
        $this->_name      = Sanitize::toTitle( Utils::getValue( @$output['basename'], '' ) );
    ...
    public function getTimestamps()
    {
        ...
        $created  = Utils::getValue( @filectime( $path ), $now );
        $modified = Utils::getValue( @filemtime( $path ), $now );
        $accessed = Utils::getValue( @fileatime( $path ), $now );
